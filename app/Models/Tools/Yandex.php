...
class Yandex
{
     ...
     * @return Yandex
     */
     public function __construct($user= "seoarsenkin", $key = "03.209967543:5c005d28cc05a5e40a687e4ae72c2f81")
     {
     ...
     * @return Yandex
     */
    public function groupby($groupby, $mode = Yandex::GROUP_MODE_DEEP)
    {
    ...
    public function request()
    {
        ...
        $ch = curl_init();
				...
				if($this->user == "arsenkin1991%40yandex.ru"){
					$url = 'http://xmlproxy.ru/xmlsearch'
						. '?user='.$this->user
            . '&key='.$this->key;
				}else{
            ...
            . '&key='.$this->key;
				...
				// $url .= "&filter=none"; // &filter=none, &filter=moderate, &filter=strict
